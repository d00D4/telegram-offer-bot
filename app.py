...
При возврате в главное меню показывается полное приветствие
"""
...
# ==================== ПРИВЕТСТВЕННЫЙ ТЕКСТ (вынесен в константу) ====================
...
def handle_callback(call):
    ...
    try:
        if callback_type == CallbackFactory.MAIN_MENU:
            ...
            # Используем ТОТ ЖЕ приветственный текст, что и в /start
